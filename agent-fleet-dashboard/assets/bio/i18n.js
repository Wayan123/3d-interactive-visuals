...
export const TRANSLATIONS = {
  en: {
    ...
    "panel.manual.subtitle": "Everything you need to explore the 16 specimens.",
  ...
  id: {
    ...
    "panel.manual.subtitle": "Semua yang perlu Anda ketahui untuk menjelajahi 16 spesimen.",

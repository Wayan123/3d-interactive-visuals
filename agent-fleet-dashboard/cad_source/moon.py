"""Science Atlas - The Moon CAD source.

Moon: small cratered sphere (Earth's satellite).
...
def make():
    ...
    body = Compound(label="moon_body", children=[Sphere(radius=0.5)])
    children = [body]

    return Compound(label="moon", children=children)
...
if __name__ == "__main__":
    ...
    export_step(make(), str(out_dir / "moon.step"))
    print(f"wrote {out_dir/'moon.step'}")
